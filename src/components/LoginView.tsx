...
import { LogIn, UserPlus, Sparkles, Database, Shield, Music2 } from 'lucide-react';
...
export const LoginView: React.FC<LoginViewProps> = ({
  ...
  return (
    <div
      ...
      className="min-h-[calc(100vh-140px)] flex flex-col items-center justify-center px-4 py-8"
    >
      {/* Brand logo header */}
      <div className="flex items-center space-x-2.5 mb-6">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-emerald-500 to-teal-400 flex items-center justify-center shadow-lg shadow-emerald-500/20">
          <Music2 className="w-6 h-6 text-zinc-950 stroke-[2.5]" />
        </div>
        <span className="text-2xl font-bold tracking-tight text-zinc-100 flex items-center gap-2">
          Aura <span className="text-emerald-400 text-xs tracking-wider uppercase px-2 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/20">Music</span>
        </span>
      </div>
